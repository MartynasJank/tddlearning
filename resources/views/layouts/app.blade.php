        ...
        <nav class="bg-header">
            <div class="container mx-auto py-2">
                <div class="flex justify-between items-center ">
                    ...
                    <!-- Right side -->
                    <div class="flex text-right text-center">
                        @guest
                            <a class="no-underline hover:underline text-default text-sm p-3" href="{{ route('login') }}">{{ __('Login') }}</a>
                            @if (Route::has('register'))
                            <a class="no-underline hover:underline text-default text-sm p-3" href="{{ route('register') }}">{{ __('Register') }}</a>
                            @endif
                        @else
